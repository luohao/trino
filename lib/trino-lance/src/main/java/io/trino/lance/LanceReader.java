...
import io.trino.lance.v2.metadata.FileVersion;
import io.trino.lance.v2.metadata.Footer;
import io.trino.lance.v2.metadata.TypeUtil;
import io.trino.lance.v2.reader.ColumnReader;
import io.trino.lance.v2.reader.Range;
...
import static io.trino.lance.v2.metadata.DiskRange.BUFFER_DESCRIPTOR_SIZE;
        ...
        implements Closeable
{
            ...
            throws IOException
    {
        ...
        // TODO: I don't see this documented in the format spec, but the rust implementation does this.
    ...
    public SourcePage nextSourcePage()
    {
        ...
        // TODO: implement exponential growth of batch size like what OrcRecordReader does.
        ...
        currentPageId++;
        SourcePage page = new LanceSourcePage(toIntExact(currentBatchSize));
        return page;
    }
