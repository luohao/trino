...
{
    static LanceEncoding fromProto(Encodings.ArrayEncoding proto)
    {
        return switch (proto.getArrayEncodingCase()) {
            ...
            default -> throw new IllegalArgumentException("Invalid encoding: " + proto.getArrayEncodingCase());
        };
    }
