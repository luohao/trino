        ...
        implements RepetitionDefinitionUnraveler
{
    ...
    public SingleUnraveler(int[] repetitionLevels, int[] definitionLevels, DefinitionInterpretation[] interpretations)
    {
        ...
        for (DefinitionInterpretation interpretation : interpretations) {
    ...
    public BlockPositions calculateOffsets()
    {
        ...
        DefinitionInterpretation currentMeaning = interpretations[currentLayer];
        ...
        for (int i = currentLayer; i < interpretations.length; i++) {
            DefinitionInterpretation level = interpretations[i];
            switch (level) {
                case NULLABLE_ITEM:
                    maxLevel++;
                    break;
