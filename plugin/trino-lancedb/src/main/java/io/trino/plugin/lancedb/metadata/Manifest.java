 ...
 */
package io.trino.plugin.lancedb.metadata;
...
import static io.trino.lance.LanceReader.toFields;
import static io.trino.plugin.lancedb.LanceDbErrorCode.LANCEDB_INVALID_METADATA;
...
public class Manifest
{
    ...
    public static Manifest from(Slice slice)
    {
        ...
        if (!Arrays.equals(MAGIC, magic)) {
            throw new TrinoException(LANCEDB_INVALID_METADATA, "Invalid MAGIC in manifest footer");
        }
        ...
        if (recordedLength != length - position - 20) {
            throw new TrinoException(LANCEDB_INVALID_METADATA, "Invalid manifest proto message length: " + recordedLength);
        }
        ...
        try {
            ...
            throw new TrinoException(LANCEDB_INVALID_METADATA, e);
        }
